...
**Tests**: Per the constitution (Principle IV — TDD is NON-NEGOTIABLE), test tasks MUST be included for every user story. Write tests first, ensure they fail, then implement.
